...
public class JsonGolemAuthSessionRepository implements GolemAuthSessionRepository {
    ...
    @Override
    public Optional<GolemAuthSession> findById(String sessionId) {
    ...
    @Override
    public void save(GolemAuthSession session) {
        try {
