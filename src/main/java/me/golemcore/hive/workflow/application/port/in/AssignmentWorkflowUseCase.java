...
public interface AssignmentWorkflowUseCase {
    ...
    List<AssignmentSuggestion> getTeamCandidates(Board board);

    List<AssignmentSuggestion> getAllCandidates(Board board);

    AssignmentSuggestion suggestDefaultAssignee(Board board);
}
