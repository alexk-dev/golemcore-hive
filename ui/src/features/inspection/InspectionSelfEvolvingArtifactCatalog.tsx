                ...
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex shrink-0 flex-col items-end gap-1">
                    {artifact.hasPendingApproval ? (
                      <span className="inline-flex items-center border border-amber-700 bg-amber-900/40 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.16em] text-amber-300">
                        approval
                      </span>
                    ) : null}
                    {artifact.hasRegression ? (
                      <span className="inline-flex items-center border border-rose-700 bg-rose-900/40 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.16em] text-rose-300">
                        regression
                      </span>
                    ) : null}
                    {artifact.stale ? (
