...
public class AssignmentWorkflowApplicationService implements AssignmentWorkflowUseCase, WorkflowAssignmentPort {

    private final GolemDirectoryUseCase golemDirectoryUseCase;

    public AssignmentWorkflowApplicationService(GolemDirectoryUseCase golemDirectoryUseCase) {
