    ...
    <div className="panel p-4">
      ...
      <label className="mt-4 grid gap-1 text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">
        ...
        <input
          ...
          className="border border-border bg-panel px-3 py-2 text-sm font-normal text-foreground outline-none transition focus:border-primary focus:ring-1 focus:ring-primary/50"
        />
      </label>
    </div>
  );
