...
public class ControlChannelPolicySyncDispatchAdapter implements PolicySyncDispatchPort {

    private static final String POLICY_SYNC_EVENT_TYPE = "policy.sync_requested";
    ...
    @Override
    public boolean requestSync(String golemId, String policyGroupId, int targetVersion, String checksum,
            Instant createdAt) {
