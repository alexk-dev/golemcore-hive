...
public class LocalNotificationDeliveryAdapter implements NotificationDeliveryPort {

    private final NotificationPort notificationPort;

    @Override
    public void deliver(NotificationEvent notificationEvent) {
        notificationPort.deliver(notificationEvent);
    }
}
