...
public record SystemSettingsSnapshot(boolean productionMode,String storageBasePath,boolean secureRefreshCookie,long highCostThresholdMicros,RetentionDefaults retention,NotificationDefaults notifications,List<NotificationEvent>recentNotifications){
