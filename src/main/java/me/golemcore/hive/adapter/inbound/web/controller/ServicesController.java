...
public class ServicesController extends BoardMappingSupport {
    ...
    @PostMapping
    public Mono<ResponseEntity<BoardDetailResponse>> createService(
            Principal principal,
    ...
    public Mono<ResponseEntity<BoardDetailResponse>> updateService(
            Principal principal,
    ...
    @PutMapping("/{serviceId}/flow")
    public Mono<ResponseEntity<BoardDetailResponse>> updateServiceFlow(
            Principal principal,
            @PathVariable String serviceId,
    ...
    @PostMapping("/{serviceId}/flow:preview")
    public Mono<ResponseEntity<RemapPreviewResponse>> previewServiceFlow(
            Principal principal,
            @PathVariable String serviceId,
    ...
    @PutMapping("/{serviceId}/team")
    public Mono<ResponseEntity<BoardDetailResponse>> updateServiceTeam(
            Principal principal,
            @PathVariable String serviceId,
