...
public class SelfEvolvingProjectionRebuildApplicationService {

    private final SelfEvolvingReadUseCase selfEvolvingReadUseCase;

    public SelfEvolvingProjectionRebuildApplicationService(SelfEvolvingReadUseCase selfEvolvingReadUseCase) {
        this.selfEvolvingReadUseCase = selfEvolvingReadUseCase;
    }

    public RebuildResult rebuildAll() {
        List<SelfEvolvingArtifactCatalogProjection> artifacts = selfEvolvingReadUseCase
