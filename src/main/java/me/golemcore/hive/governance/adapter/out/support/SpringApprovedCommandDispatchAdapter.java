...
public class SpringApprovedCommandDispatchAdapter implements ApprovedCommandDispatchPort {

    private final ApplicationEventPublisher applicationEventPublisher;

    @Override
    public void dispatchApprovedCommand(String commandId) {
        applicationEventPublisher.publishEvent(new ApprovedCommandDispatchRequestedEvent(commandId));
    }
}
