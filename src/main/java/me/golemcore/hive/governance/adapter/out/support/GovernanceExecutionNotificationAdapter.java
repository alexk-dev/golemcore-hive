...
public class GovernanceExecutionNotificationAdapter implements ExecutionNotificationPort {

    private final NotificationUseCase notificationUseCase;

    @Override
    public NotificationEvent create(NotificationEvent.NotificationEventBuilder builder) {
        return notificationUseCase.create(builder);
    }

    @Override
    public boolean isBlockerRaisedEnabled() {
        return notificationUseCase.isBlockerRaisedEnabled();
    }

    @Override
    public boolean isCommandFailedEnabled() {
        return notificationUseCase.isCommandFailedEnabled();
    }
}
